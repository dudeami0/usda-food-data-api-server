...
import { defaultFoodQuery, getFood } from "../helpers/usda-v1.js";
 ...
 */
function sanitizeFormatType(input) {
 ...
 */
function handleApi(ctx, docs, format) {
    if (docs) {
 ...
 */
async function handleSearchApi(ctx) {
